---
title: "API reference"
description: "The whole public surface of package:monolens/monolens.dart, grouped by what it is for."
---
...
Test doubles are in `package:monolens/testing.dart` and are covered in [testing](/monolens/guides/testing/).
...
See [capture](/monolens/guides/capture/).
...
See [editing](/monolens/guides/editing/).
...
See [annotations](/monolens/guides/annotations/).
...
| Not here | Why |
|---|---|
| Widgets | The package is headless. See [architecture](/monolens/reference/architecture/#why-headless). |
