---
title: "Annotations"
description: "Text, stickers, blur and strokes, burned into a still or into every frame of a clip."
---
...
Draw previews with `BoxFit.fill`, and make placement rects square *in pixels* rather than in normalized units; [building an editor](/monolens/guides/building-an-editor/#the-square-rect-trap) has the arithmetic.
...
See [architecture](/monolens/reference/architecture/#the-video-pipeline).
